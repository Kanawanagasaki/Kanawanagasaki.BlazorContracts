...
[Authorize]
public class AuthMeHandler : IContractHandler<AuthMeContract, AuthUserInfo>
{
    public required IHttpContextAccessor HttpContextAccessor { get; init; }

    public Task<ContractResult<AuthUserInfo>> HandleAsync(AuthMeContract contract, CancellationToken ct = default)
    {
