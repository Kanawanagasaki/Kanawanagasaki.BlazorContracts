...
public class TestPostSimpleBodyHandler : IContractHandler<TestPostSimpleBodyContract, SimpleTestResponse>
{
    public Task<ContractResult<SimpleTestResponse>> HandleAsync(TestPostSimpleBodyContract contract, CancellationToken ct = default)
    {
